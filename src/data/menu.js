...
export const defaultMenu = {
  categories: [
    ...
    },
    {
      ...
      name: 'Jus',
      items: [
        { id: 'j1', name: 'Alain Millat Abricot', price: 0, description: '' },
        { id: 'j2', name: 'Alain Millat Fraise', price: 0, description: '' },
        { id: 'j3', name: 'Alain Millat Pêche', price: 0, description: '' },
        { id: 'j4', name: 'Alain Millat Pomme Coing', price: 0, description: '' },
        { id: 'j5', name: 'Alain Millat Citron Gingembre', price: 0, description: '' },
        { id: 'j6', name: "Jus d'Ananas", price: 0, description: '' },
        { id: 'j7', name: 'Jus de Fruits', price: 0, description: '' },
        { id: 'j8', name: 'Jus Tomate', price: 0, description: '' },
      ],
    },
    {
      id: 'jus-presses',
      name: 'Jus Pressés',
      items: [
        { id: 'jp1', name: 'Citron Pressé', price: 0, description: '' },
        { id: 'jp2', name: 'Orange Pressée', price: 0, description: '' },
        { id: 'jp3', name: 'Pamplemousse Pressé', price: 0, description: '' },
      ],
    },
    {
      id: 'cocktails',
      name: 'Cocktails',
      items: [
        { id: 'ck1', name: 'Amaretto Sour', price: 0, description: '' },
        { id: 'ck2', name: 'Americano', price: 0, description: '' },
        { id: 'ck3', name: 'AMF', price: 0, description: '' },
        { id: 'ck4', name: 'Angel Face', price: 0, description: '' },
        { id: 'ck5', name: 'Aperol Spritz', price: 0, description: '' },
        { id: 'ck6', name: 'B52', price: 0, description: '' },
        { id: 'ck7', name: 'Bar là-Bas Spritz', price: 0, description: '' },
        { id: 'ck8', name: 'Bellini', price: 0, description: '' },
        { id: 'ck9', name: 'Between the Sheets', price: 0, description: '' },
        { id: 'ck10', name: 'Black Jameson', price: 0, description: '' },
        { id: 'ck11', name: 'Black Russian', price: 0, description: '' },
        { id: 'ck12', name: 'Bloody Mary', price: 0, description: '' },
        { id: 'ck13', name: 'Bobby Burns', price: 0, description: '' },
        { id: 'ck14', name: 'Boulevardier', price: 0, description: '' },
        { id: 'ck15', name: 'Bourbon Manhattan', price: 0, description: '' },
        { id: 'ck16', name: 'Bourbon Sour', price: 0, description: '' },
        { id: 'ck17', name: 'Bramble', price: 0, description: '' },
        { id: 'ck18', name: 'Brandy Alexander', price: 0, description: '' },
        { id: 'ck19', name: 'Brandy Flip', price: 0, description: '' },
        { id: 'ck20', name: 'Brandy French', price: 0, description: '' },
        { id: 'ck21', name: 'Brave Bull', price: 0, description: '' },
        { id: 'ck22', name: 'Bronx', price: 0, description: '' },
        // More cocktails can be added via the Menu page
      ],
    },
    {
      id: 'bieres',
